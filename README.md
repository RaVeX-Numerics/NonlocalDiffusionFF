...
`FF` is a MATLAB function designed to solve a Fisher-KPP equation with nonlocal diffusion and free boundaries by using Front-Fixing Transformation. 
...
```matlab
[X,W,H,G,t] = FF(scheme, M,T, mu, h0, u0, alpha2, f, J, K,dt)
```
